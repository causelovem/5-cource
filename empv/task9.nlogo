...
to setup
  ...
  set alpha 0.2 + random-float 0.2
  set beta 0.2 + random-float 0.2
  set gamma 0.1 + random-float 0.1
...
to update-heading
  let mates 0
  ifelse not cone?
  [set mates other birds in-radius vision]
  [set mates other birds in-cone vision 180]
